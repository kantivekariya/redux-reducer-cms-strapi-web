            ...
            <div className="col-8 text-right">
              <nav className="site-navigation" role="navigation">
                <ul className="site-menu js-clone-nav mr-auto d-none d-lg-block mb-0 pr-5">
                  <li>
                    <Link to={`${window.location.pathname}`}>Home</Link>
                  </li>
                  <li>
                    <Link to={`${window.location.pathname}`}>About</Link>
                  </li>
                  <li>
                    <Link to={`${window.location.pathname}`}>Contact</Link>
                  </li>
                  <li className="d-none d-lg-inline-block">
                    <Link
                      to={`${window.location.pathname}`}
                      className="js-search-toggle"
                    >
                      <span className="icon-search"></span>
                    </Link>
                  </li>
