      ...
      <div className="site-wrap">
        ...
        {blogs_details && blogs_details.data && (
          <div
            ...
            style={{
              backgroundImage: `url(${config.BASE_URL}${
                blogs_details &&
                blogs_details.data &&
                blogs_details.data.cover &&
                blogs_details.data.cover.url
              })`,
            }}
          >
                ...
                <div className="col-md-12 col-lg-10">
                  <div className="post-entry text-center">
                    <span className="post-category text-white bg-success mb-3">
                      {blogs_details &&
                        blogs_details.data &&
                        blogs_details.data.category &&
                        blogs_details.data.category.category}
                    </span>
                    <h1 className="mb-4">
                      {blogs_details &&
                        blogs_details.data &&
                        blogs_details.data.title &&
                        blogs_details.data.title}
                    </h1>
                    <div className="post-meta align-items-center text-center">
                      <figure className="author-figure mb-0 mr-3 d-inline-block">
                        <img
                          src={`${config.BASE_URL}${
                            blogs_details &&
                            blogs_details.data &&
                            blogs_details.data.profile_image &&
                            blogs_details.data.profile_image.url &&
                            blogs_details.data.profile_image.url
                          }`}
                          alt="img_1"
                          className="img-fluid"
                      ...
                      <span className="d-inline-block mt-1">
                        By{" "}
                        {blogs_details &&
                          blogs_details.data.author &&
                          blogs_details.data.author[0] &&
                          blogs_details.data.author[0].username}
                      </span>
                      <span>
                        &nbsp;-&nbsp;{" "}
                        {moment(
                          blogs_details && blogs_details.createdAt
                        ).format("MMMM DD, YYYY")}
                      </span>
                    </div>
                  </div>
              ...
              <div className="col-md-12 col-lg-8 main-content">
                <div className="post-content-body">
                  <div>
                    {blogs_details &&
                      blogs_details.data &&
                      blogs_details.data.content &&
                      blogs_details.data.content[0] &&
                      blogs_details.data.content[0].Rich_text &&
                      parse(blogs_details.data.content[0].Rich_text)}
                  </div>
                </div>
              </div>
